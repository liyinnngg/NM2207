...
\begin{figure}
\includegraphics[width=800px,height=400px]{info of read_csv} \caption{more information about `read_csv()` command}\label{fig:unnamed-chunk-5}
\end{figure}
...
\includegraphics{Challenge-2_files/figure-latex/unnamed-chunk-19-1.pdf}
